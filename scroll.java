...
import javax.swing.*;
import java.awt.*;
public  class scroll extends Frame implements AdjustmentListener,ActionListener
{
	Panel p;
	Label l1,l2,l3;
	Button b1,b2,b3,b4,bquit;
	GridLayout g;
	Font f;
	Scrollbar s1,s2,s3;
	public scroll()
	{
		...
		bquit.setBounds(140,140,150,30);
